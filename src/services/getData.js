...
export async function getPolularSeries() {
...
export async function getMoviesChanges(movieId) {
...
export async function getMovieDiscovery(movieId) {

    const { data: { results } } = await api.get(`movie/${movieId}/recommendations`)


    return results
}

export async function getMoviesPopular(movieId) {
